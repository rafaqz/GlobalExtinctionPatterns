...
function get_subsets(full_df;
    ...
    subset_queries = (;
        invasive_caused=(title="Invasive", query=(invasive_caused,)),
        human_caused=(title="Human hunting", query=(human_caused,)),
        lcc_caused=(title="Land cover", query=(lcc_caused,)),
        other_caused=(title="Other", query=(other_caused,)),
